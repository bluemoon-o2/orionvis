...
try:
    ...
    raise ImportError(
        "Failed to import cross_scan_fn/cross_merge_fn from csm_triton. "
        "Check if csm_triton.py exists in the same directory as vmambanew.py."
    ) from e
...
try:
    ...
    raise ImportError(
        "Failed to import cross_scan_fn_k2/cross_merge_fn_k2 from csm_tritonk2. "
        "Check if csm_tritonk2.py exists in the same directory as vmambanew.py."
    ) from e
...
try:
    ...
    raise ImportError(
        "Failed to import selective_scan_fn/selective_scan_flop_jit from csms6s. "
        "Check if csms6s.py exists in the same directory as vmambanew.py."
    ) from e
